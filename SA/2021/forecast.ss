...
#C forecast file for: Convenio de Desempeno 2022 Estatus y posibilidades de explotacion biologicamente sustentables de Merluza comun, 2023. Caso 3.
...
0 0 0 0 0 0 #_Fcast_years:  beg_selex, end_selex, beg_relF, end_relF, beg_mean recruits, end_recruits  (enter actual year, or values of 0 or-integer to be rel. endyr) 0 0 -10 0 -999 0
...
2004 # Rebuilder:  first year catch could have been set to zero (Ydecl)(-1 to set to 1999)
2004 # Rebuilder:  year for current age structure (Yinit) (-1 to set to endyear+1)
