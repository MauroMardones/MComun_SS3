...
#C Convenio de Desempeno 2022 Estatus y posibilidades de explotacion biologicamente sustentables de Merluza comun, 2023. Caso 3
datos_14021.ss
caso3_ctl.ss
...
200 # MCeval thin interval
0 # jitter initial parm value by this fraction
2001 # min yr for sdreport outputs (-1 for styr); #_1969
2020 # max yr for sdreport outputs (-1 for endyr+1; -2 for endyr+Nforecastyrs); #_2011
...
-1 # random number seed for bootstrap data (-1 to use long(time) as seed): # 1624632925
